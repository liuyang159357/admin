  ...
  <div class="attr">
    ...
    <el-card>
      <div v-show="isShowTable">
        <el-button type="primary" icon="el-icon-plus" style="margin-bottom: 10px" :disabled="!idFrom.category3"
        ...
        <el-table :data="attrList" border>
          ...
          <el-table-column align="center" prop="1" label="操作" width="150">
            <template slot-scope="{row}">
              <el-button type="warning" icon="el-icon-edit" size="mini" @click="editAttrValue(row)"></el-button>
        ...
        <el-table :data="attrInfo.attrValueList" style="width: 100%;margin: 20px 0;" border>
          ...
          <el-table-column label="属性值名称">
            <template slot-scope="{row,$index}">
              <el-input v-if="row.flag" :ref="$index" v-model="row.valueName" placeholder="请输入属性值名称" size="mini"
                @blur="toLook(row)" @keydown.enter.native="row.flag = false"></el-input>
